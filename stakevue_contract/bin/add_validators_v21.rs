//! Add validators to StakeVue V21 contract (Odra 2.5.0)
//! Run with: cargo run --bin add_validators_v21 --features livenet
...
fn main() {
    ...
    println!("=== Adding Validators to StakeVue V21 ===");
    ...
    println!();
    println!("Next: Test stake with: cargo run --bin test_stake_v21 --features livenet");
}
